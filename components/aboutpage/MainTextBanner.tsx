...
const AboutUsTextBanner = () => {
    return (
        <section className={styles.text_banner_container}>
           ...
           <div className={styles.information_containers_section}>
                <div className={styles.information_container}>
                    <IoShirtOutline className={styles.information_icon} />
                ...
                <div className={styles.information_container}>
                    <GiEcology className={styles.information_icon} />
                ...
                <div className={styles.information_container}>
                    <ImLocation className={styles.information_icon} />
